...
**providers/server_provider.dart (modify):**
- Inject CertificateService dependency
- Update startServer() method:
  - Call certificateService.generateOrLoadCertificate() to get cert PEM strings
  - Call certificateService.createSecurityContext(certPem, keyPem)
  - Pass SecurityContext to PhoneSyncServer.start(securityContext: context)
  - (discoveryService.advertise() call from Plan 01 remains)
  </action>
  <verify>
